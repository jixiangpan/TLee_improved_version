...
void plot_stat_FC(double bestFit)
{  
  //////////////////////////////////////////////////////////////////////////////////////// Draw style
  ...
  for( int ientry=0; ientry<entries_Asimov; ientry++ ) {
    if( ientry%max(1, entries_Asimov/10)==0 ) cout<<Form(" ---> processing %5.2f, %4d", ientry*1./entries_Asimov, ientry)<<endl;
  ...
  canv_gh_scan_dchi2_data->SaveAs("canv_bestfit_data.png");
